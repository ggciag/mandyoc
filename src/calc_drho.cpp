...
PetscErrorCode calc_pressure()
{
	...
	if (DIMEN==2){
		...
		ierr = DMDAGetElementCorners3d(da_Thermal,&sex,&sey,&sez,&mx,&my,&mz);CHKERRQ(ierr);
		
		ierr = DMDAGetElementCorners3d(da_Veloc,&sex1,&sey1,&sez1,&mx1,&my1,&mz1);CHKERRQ(ierr);
