...
PetscErrorCode AssembleA_Veloc3d(Mat A,Mat AG,DM veloc_da, DM temper_da){
	...
	ierr = DMDAGetElementCorners3d(veloc_da,&sex,&sey,&sez,&mx,&my,&mz);CHKERRQ(ierr);
...
PetscErrorCode AssembleF_Veloc3d(Vec F,DM veloc_da,DM drho_da,Vec FP){
	...
	ierr = DMDAGetElementCorners3d(drho_da,&sex,&sey,&sez,&mx,&my,&mz);CHKERRQ(ierr);
	
	PetscInt               sex1,sey1,sez1,mx1,my1,mz1;

	ierr = DMDAGetElementCorners3d(veloc_da,&sex1,&sey1,&sez1,&mx1,&my1,&mz1);CHKERRQ(ierr);
